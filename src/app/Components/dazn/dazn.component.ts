...
export class DAZNComponent {
  ...
  constructor(private sanitizer: DomSanitizer) {
    const defaultVideoUrl = 'https://dearch.vin/mpdk.html?get=aHR0cHM6Ly9kY2UtYWstbGl2ZXd3ZGF6bi5ha2FtYWl6ZWQubmV0L2Rhc2hkcm0vZGF6bi1saW5lYXItMDQzL3N0cmVhbS5tcGQ/cD13ZWI&key=ODJmOGUyYTE3ZGFjNDRjMGExOGY2NjA0NzkzNDljNTk&key2=MWIxNDRmNzNlNmZlZmU5MWNkMDVmODUwZTJiNTg5ZDA';
    this.videoPrincipal = this.sanitizer.bypassSecurityTrustResourceUrl(defaultVideoUrl);
  }
  ...
  cargarVideo(video: Video): void {
    ...
    if (index !== -1) {
      // Mover el video seleccionado al principio de la lista
